...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Make rails console less dangerous!}
  spec.description   = %q{This gem makes console sessions less dangerous in specified environments by warning, color-coding, auto-sandboxing, and disabling external connections, job queueing, etc.}
  ...
  if spec.respond_to?(:metadata)
    spec.metadata["allowed_push_host"] = "http://not-a-real-server.com"
  else
