module SaferRailsConsole
  module Patches
    module DisableSandboxFlag
        ...
        module CommandsTasks
          def console
            ...
            if SaferRailsConsole::RailsVersion.four_two?
              Rails::Console.prepend(SaferRailsConsole::Patches::DisableSandboxFlag::Rails::Console42)
      ...
      if SaferRailsConsole::RailsVersion.four_two? || SaferRailsConsole::RailsVersion.five_zero?
        ::Rails::CommandsTasks.prepend(SaferRailsConsole::Patches::DisableSandboxFlag::Rails::CommandsTasks)
